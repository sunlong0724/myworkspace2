...
int CDeckLinkInputDevice::input_reference_counter = 0;
void* CDeckLinkInputDevice::inputDeckLinkIterator = NULL;
...
void CDeckLinkInputDevice::DestroyObjects() {
	...
	if (--input_reference_counter == 0 && inputDeckLinkIterator != NULL)
		((IDeckLinkIterator*)inputDeckLinkIterator)->Release();
...
bool CDeckLinkInputDevice::CreateObjects(int k) {
	...
	if (NULL == inputDeckLinkIterator) {
		if (GetDeckLinkIterator((IDeckLinkIterator**)(&inputDeckLinkIterator)) != S_OK)
		{
			fprintf(stderr, "A DeckLink iterator could not be created.  The DeckLink drivers may not be installed.\n");
			goto bail;
		}
		input_reference_counter++;
	}
	else {
		input_reference_counter++;
	}
	...
	for (int i = 0; i < MAX_DEVICES_COUNT; ++i) {
		...
		result = (((IDeckLinkIterator*)inputDeckLinkIterator)->Next((IDeckLink**)(&deckLink)));
